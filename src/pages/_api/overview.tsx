        ...
        <main>
          ...
          <article>
            ...
            <p>
              ...
              responsible for rendering the data through the Document Object
              Model (DOM).
            </p>
            <p>
          ...
          <article>
            <h4>API Keys</h4>
            <p>
              Phrase API needs to secure its endpoints to prevent unauthorized
              access. With this, anyone that aims to access our API must provide
              an API key. The API key is a unique token or identifier that
              authenticates requests to communicate with another application.
            </p>
